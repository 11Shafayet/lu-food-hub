                        ...
                        <ul class="totals-table">
                            ...
                            <form id="checkoutForm" action="order.php" method="post">
											...
											<!-- ... -->
                                                        ...
                                                        <li class="text-right">
                <a href="checkout.php">
                    <button type="button" class="theme-btn btn-style-five proceed-btn">
...
//             alert("Cart Deleted Successfully"); // Provide a success message
//             window.location = "view-cart.php"; // Redirect to the cart page
//         }
//     };
//     xmlhttp1.open("GET", "delete_from_cart.php?tb_id=" + tb_id, true); // Corrected space before tb_id
//     xmlhttp1.send();
// }
